...
class RegionDetector extends StatefulWidget {
  ...
  @override
  State<RegionDetector> createState() => _RegionDetectorState();
}

class _RegionDetectorState extends State<RegionDetector> {
